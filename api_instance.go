...
/*
InstanceApiService Check service status
...
/*
InstanceApiService Get instance metrics
Get metrics about this Gilfoyle instance
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return UtilDataResponse
*/
func (a *InstanceApiService) GetMetrics(ctx context.Context) (UtilDataResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/metricsz"
